...
/**
 * Entity representing the response from a CollectCall transaction cancellation request.
 *
 ...
 *
 * <p>Database Mapping:
 * Stored in table {@code CollectCall_cancel_transactions_response} for audit
 ...
 */
@Entity
@Table(name = "collect_call_cancel_transactions_response")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(name = "CollectCallCancelTransactionResponse", description = "Response payload for CollectCall transaction cancellation")
public class CollectCallCancelTransactionResponse {
