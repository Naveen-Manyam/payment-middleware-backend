...
/**
 * Entity representing a request to cancel a CollectCall transaction.
 *
 ...
 *
 * <p>Database Mapping:
 * Stored in table {@code CollectCall_cancel_transactions_request} with auto-generated
 ...
 */
@Entity
@Table(name = "collect_call_cancel_transactions_request")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(name = "CollectCallCancelTransactionRequest", description = "Request payload for cancelling a CollectCall transaction")
public class CollectCallCancelTransactionRequest {
