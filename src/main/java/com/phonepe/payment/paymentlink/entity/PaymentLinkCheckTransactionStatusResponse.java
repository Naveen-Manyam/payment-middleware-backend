...
/**
 * Entity representing the response from a PaymentLink transaction status check request.
 *
 ...
 *
 * <p>Database Mapping:
 * Stored in table {@code paymentlink_transactions_status_response} with
 ...
 */
@Entity
@Table(name = "paymentlink_transactions_status_response")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(name = "PaymentLinkCheckTransactionStatusResponse", description = "Response payload for PaymentLink transaction status check")
public class PaymentLinkCheckTransactionStatusResponse {
