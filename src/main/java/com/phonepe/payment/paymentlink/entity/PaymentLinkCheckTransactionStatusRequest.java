...
/**
 * Entity representing a request to check the status of a PaymentLink transaction.
 *
 ...
 *
 * <p>Database Mapping:
 * Stored in table {@code paymentlink_transactions_status_request} with
 ...
 */
@Entity
@Table(name = "paymentlink_transactions_status_request")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(name = "PaymentLinkCheckTransactionStatusRequest", description = "Request payload for checking PaymentLink transaction status")
public class PaymentLinkCheckTransactionStatusRequest {
