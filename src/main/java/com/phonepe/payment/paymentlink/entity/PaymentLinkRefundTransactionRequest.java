...
/**
 * Entity representing a request to refund a completed PaymentLink transaction.
 *
 ...
 *
 * <p>Database Mapping:
 * Stored in table {@code paymentlink_refund_transactions_request} with
 ...
 */
@Entity
@Table(name = "paymentlink_refund_transactions_request")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(name = "PaymentLinkRefundTransactionRequest", description = "Request payload for refunding a PaymentLink transaction")
public class PaymentLinkRefundTransactionRequest {
