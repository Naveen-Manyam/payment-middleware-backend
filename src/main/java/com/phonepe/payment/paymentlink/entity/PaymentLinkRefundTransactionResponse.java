 ...
 */
@Entity
@Table(name = "paymentlink_refund_transactions_response")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(name = "PaymentLinkRefundTransactionResponse", description = "Response payload for PaymentLink transaction refund")
public class PaymentLinkRefundTransactionResponse {
